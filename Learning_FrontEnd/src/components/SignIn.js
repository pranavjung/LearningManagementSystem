      ...
      authServices
        ...
        .then((data) => {
          ...
          if (data.data.success) {
            ...
            if (data.data.data.user.designation === "FACULTY") {
              localStorage.setItem("FACULTY", data.data.data.user.userId);
              this.props.history.push("/TeachersDashboard");
            } 
            else if(data.data.data.user.designation === "BACK_OFFICE_STAFF"){
              
              localStorage.setItem("BACK_OFFICE_STAFFId", data.data.data.user.userId);
              this.props.history.push("/OfficeDashboard");
            }
           else{
            localStorage.setItem("Student", data.data.data.user.userId);
            localStorage.setItem("StudentID", data.data.data.student.studentId);
